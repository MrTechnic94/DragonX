...
module.exports = {
    ...
    async run(_client, message) {
        ...
        if (queue.filters.ffmpeg.getFiltersEnabled().length >= config.playerOptions.maxFiltersEnabled && queue.filters.ffmpeg.isDisabled('nightcore')) return message.channel.send({ embeds: [messageEmbeds.max_filters_enabled_error] });
