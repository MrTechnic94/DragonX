...
exports.run = async (client, message, args) => {
    ...
    try {
        ...
        if (queue.repeatMode === 1 || queue.repeatMode === 2) await queue.setRepeatMode(0);
    ...
    try {
        ...
        if (queue.repeatMode === 0) await queue.setRepeatMode(1);
    ...
    try {
        ...
        if (queue.repeatMode === 0) await queue.setRepeatMode(2);
